...
class TestPaired(unittest.TestCase):
    ...
    def test_load(self):
        ...
        self.assertEqual(rs.reads_files[0] ,'/proj/hoodlab/share/vcassen/rna-seq/rnaseq/t/fixtures/readsets/s_1_1.fq')
        self.assertEqual(rs.reads_files[1] ,'/proj/hoodlab/share/vcassen/rna-seq/rnaseq/t/fixtures/readsets/s_1_2.fq')
